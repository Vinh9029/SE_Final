  ...
  <div class="max-w-xl mx-auto py-10">
    ...
    <form class="bg-white rounded-2xl shadow p-8 flex flex-col gap-6">
      <div>
        ...
        <input type="text" class="border rounded px-4 py-2 w-full focus:outline-none focus:ring-2 focus:ring-orange-200" placeholder="Nhập tên sản phẩm" />
      </div>
      <div>
        <label class="block text-sm font-semibold text-gray-700 mb-1">Giá</label>
        <input type="number" class="border rounded px-4 py-2 w-full focus:outline-none focus:ring-2 focus:ring-orange-200" placeholder="Nhập giá" />
      </div>
      <div>
        <label class="block text-sm font-semibold text-gray-700 mb-1">Loại sản phẩm</label>
        <select class="border rounded px-4 py-2 w-full focus:outline-none focus:ring-2 focus:ring-orange-200">
